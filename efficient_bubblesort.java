package efficientbubblesort;



public class efficient_bubblesort 
{public static  void buble_sort(int a[])
{
	...
	{	//complexity is o(n*n)
		...
		if (swap == false)//flag is used to avoid unnecessary iteration
	        break;// that gives complexity o(n)
...
{
	efficient_bubblesort  ob = new efficient_bubblesort ();
